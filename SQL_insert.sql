...
INSERT INTO Imovel
	(numero_imovel, cod_condom, taxa_condominio, valor_aluguel, vagas_garagem, qtd_quartos, qtd_banheiros, qtd_suites, varanda, area_metros_quadrado)
VALUES
	(1, 1, 100.00, 500.00, 1, 2, 1, 0, FALSE, 40),
    (2, 1, 100.00, 500.00, 1, 2, 1, 0, FALSE,  40),
    (3, 1, 100.00, 500.00, 1, 2, 1, 0, FALSE,  40),
    (4, 1, 100.00, 500.00, 1, 2, 1, 0, FALSE,  40),
    (5, 1, 100.00, 500.00, 1, 2, 1, 0, FALSE,  40),
    (10, 2, 200.00, 700.00, 2, 2, 1, 1, FALSE,  50),
    (20, 2, 200.00, 700.00, 2, 2, 1, 1, FALSE,  50),
    (30, 2, 200.00, 700.00, 2, 2, 1, 1, FALSE,  50),
    (40, 2, 200.00, 700.00, 2, 2, 1, 1, FALSE,  50),
    (50, 2, 200.00, 700.00, 2, 2, 1, 1, FALSE,  50),
    (60, 2, 200.00, 700.00, 2, 2, 1, 1, FALSE,  50),
    (70, 2, 200.00, 700.00, 2, 2, 1, 1, FALSE,  50),
    (101, 3, 150.00, 400.00, 0, 1, 1, 0, FALSE,  35),
    (102, 3, 150.00, 400.00, 0, 1, 1, 0, FALSE,  35),
    (103, 3, 150.00, 400.00, 0, 1, 1, 0, FALSE,  35),
    (104, 3, 150.00, 400.00, 0, 1, 1, 0, FALSE,  35),
    (105, 3, 150.00, 400.00, 0, 1, 1, 0, FALSE,  35),
    (106, 3, 150.00, 400.00, 0, 1, 1, 0, FALSE,  35),
    (107, 3, 150.00, 400.00, 0, 1, 1, 0, FALSE,  35),
    (108, 3, 150.00, 400.00, 0, 1, 1, 0, FALSE,  35),
    (109, 3, 150.00, 400.00, 0, 1, 1, 0, FALSE,  35),
    (110, 3, 150.00, 400.00, 0, 1, 1, 0, FALSE,  35),
    (201, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (202, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (203, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (204, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE, 95),
    (205, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (206, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (207, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (208, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (209, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (210, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE, 95),
    (211, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (212, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (213, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE, 95),
    (214, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (215, 4, 300.00, 1000.00, 4, 5, 2, 3, FALSE,  95),
    (1001, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE, 45),
    (1002, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1003, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1004, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1005, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1006, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1007, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1008, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1009, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1010, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1011, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1012, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1013, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1014, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1015, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1016, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1017, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1018, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1019, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45),
    (1020, 5, 125.00, 480.00, 1, 1, 1, 1, FALSE,  45);
